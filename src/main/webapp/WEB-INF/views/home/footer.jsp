<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <footer class="mt-5" style="font-family: 'Montserrat', sans-serif; padding-top: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-md-3 footer-section">
                    <h2>KICAP thay thế bằng logo</h2>
                    <p>HỘ KINH DOANH KICAP</p>
                    <p>Chứng nhận ĐKKD số: 01A8035150 do phòng TC-KH UBND quận Ba Đình cấp ngày 07/11/2023</p>
                    <p>Công viên phầm mềm Quang Trung</p>
                    <p>090xxxxxx</p>
