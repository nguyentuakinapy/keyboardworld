		...
		<div class="col-3 mt-3">
			<article>
				...
				<div class="list-group borderless">
					<a href="#" class="list-group-item list-group-item-action">Trang
						chủ</a>
					<div class="list-group-item p-1">
						<div class="btn-group w-100 borderless list-group-item-action">
						...
						<div class="collapse" id="collapseExample">
							<ul class="p-0">
								<li class="list-group-item"><input
									...
									for="firstCheckbox">keycap 1</label></li>
								<li class="list-group-item"><input
									class="form-check-input me-1" type="checkbox" value=""
									id="secondCheckbox"> <label class="form-check-label"
									for="secondCheckbox">keycap 2</label></li>
								<li class="list-group-item"><input
									class="form-check-input me-1" type="checkbox" value=""
									id="thirdCheckbox"> <label class="form-check-label"
									for="thirdCheckbox">keycap 3</label></li>
							</ul>
						</div>
					</div>
					<a href="#" class="list-group-item list-group-item-action">Bàn
						phím cơ</a> <a href="#" class="list-group-item list-group-item-action">Pre-order</a>
					<a href="#" class="list-group-item list-group-item-action">Chuột</a>
					<div class="list-group-item p-1">
					...
					<a href="#" class="list-group-item list-group-item-action">Bài
						viết</a>
					<div class="list-group-item p-1">
						<div class="btn-group w-10 borderless list-group-item-action">
							<button class="btn w-100 text-start" type="button"
				...
				<div class="">
					...
					<ul class="list-group borderless">
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="firstCheckbox"> <label class="form-check-label"
							for="firstCheckbox">Cherry</label></li>
					</ul>
					<hr>
				</div>
				<div class="">
					...
					<ul class="list-group borderless">
						...
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="secondCheckbox"> <label class="form-check-label"
							for="secondCheckbox">Sa</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="thirdCheckbox"> <label class="form-check-label"
							for="thirdCheckbox">Oem</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="firstCheckbox"> <label class="form-check-label"
							for="firstCheckbox">Asa</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="secondCheckbox"> <label class="form-check-label"
							for="secondCheckbox">Dyesub</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="thirdCheckbox"> <label class="form-check-label"
							for="thirdCheckbox">Doubleshot</label></li>
					</ul>
					<hr>
				</div>
				<div class="">
					...
					<ul class="list-group borderless">
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="firstCheckbox"> <label class="form-check-label"
							for="firstCheckbox">Keydous</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="secondCheckbox"> <label class="form-check-label"
							for="secondCheckbox">Kicap</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="thirdCheckbox"> <label class="form-check-label"
							for="thirdCheckbox">Monka</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="firstCheckbox"> <label class="form-check-label"
							for="firstCheckbox">Xinmeng</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="secondCheckbox"> <label class="form-check-label"
							for="secondCheckbox">Akko</label></li>
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="thirdCheckbox"> <label class="form-check-label"
							for="thirdCheckbox">AULA</label></li>
					</ul>
					<hr>
				</div>
				<div class="">
				...
				<div class="">
					...
					<ul class="list-group borderless">
						...
						<li class="list-group-item"><input
							class="form-check-input me-1" type="checkbox" value=""
							id="secondCheckbox"> <label class="form-check-label"
							for="secondCheckbox">KIT</label></li>
					</ul>
				</div>
			</article>
		</div>
			...
			<aside>
				<div class="">
					<ul
						...
						<h5 class="">Xếp theo:</h5>
						<li class="list-group-item borderless">
							<!-- <label class="form-check-label" for="firstRadio">Xếp theo:</label> -->
						</li>
